import{p as U}from"./chunk-WASTHULE-5L3HoGJa.js";import{p as H}from"./treemap-GDKQZRPO-K4MNJ6LD-DDyT5z-n.js";import{g as Q,s as V,a as Z,b as j,v as q,t as J,c as s,l as w,d as K,G as X,a7 as Y,aQ as ee,aR as G,aS as te,f as ae,A as re,aT as ie,H as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-ClRYiE5-.js";import"./chunk-MFRUYFWM-JC3-9eUu.js";import"./index-C9xXFxsZ.js";import"./modules/vue-JzpNrJ-0.js";import"./modules/shiki-DRgz-KAq.js";import"./modules/file-saver-B7oFTzqn.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),de=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),pe=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),R={getConfig:ne,clear:ce,setDiagramTitle:J,getDiagramTitle:q,setAccTitle:j,getAccTitle:Z,setAccDescription:V,getAccDescription:Q,addSection:de,getSections:pe,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await H("pie",e);w.debug(a),fe(a,R)},"parse")},me=s(e=>`
  .pieCircle{
