import{p as U}from"./chunk-WASTHULE-DCfGYkyW.js";import{p as q}from"./treemap-GDKQZRPO-K4MNJ6LD-Bg3ePaXZ.js";import{g as V,s as Z,a as j,b as H,t as J,q as K,_ as s,l as w,c as Q,F as X,a6 as Y,a8 as ee,a9 as G,aa as te,e as ae,z as re,ab as ie,G as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-y-M4HRqc.js";import"./chunk-MFRUYFWM-BN3d5D1Q.js";import"./index-BF958lwa.js";import"./modules/vue-C-IJWY7U.js";import"./modules/shiki-b8YsqLFS.js";import"./modules/file-saver-B7oFTzqn.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:K,getDiagramTitle:J,setAccTitle:H,getAccTitle:j,setAccDescription:Z,getAccDescription:V,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),he={parse:s(async e=>{const a=await q("pie",e);w.debug(a),fe(a,W)},"parse")},me=s(e=>`
  .pieCircle{
