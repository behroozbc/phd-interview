...
I propose a refined hybrid RAG framework inspired by PathRAG and RAFT techniques for better alignment.
...
- Dataset: A small Persian and English parallel data.
...
- Dataset: FLORES-200 dataset and the dataset of the attention heads part.
